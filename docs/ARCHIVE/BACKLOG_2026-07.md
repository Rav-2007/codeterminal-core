# Backlog archive — work completed on or before 2026-08-01

**Split out of `BACKLOG.md` on 2026-08-01.** Every section below is a record of
work that is finished. It is reproduced **verbatim** — not summarized, not
re-worded, not re-graded — because the value here is the evidence trail: the
commit SHAs, the live-verification transcripts, and the measured numbers that
say *why* each decision went the way it did.

Nothing in this file is a to-do. If an entry below reads like an open item, it
is a snapshot of what was true when it was written, not a claim about today.
Two known examples, left in place rather than edited:

- the 2026-07-10 managed-proxy entry warns "proxy has NO auth yet" — auth
  shipped later (`authorize`, `proxy/main.go`);
- several entries end "verified, NOT closed", which was accurate at the time.

**For what is actually open, read these instead:**

| Question | Document |
|---|---|
| What bugs are open? | `docs/OPEN_ITEMS.md` — the register, re-derived against source |
| What needs a founder ruling? | `docs/DECISION_PACK.md` — eight rulings, D1–D8 |
| What is still ahead? | `BACKLOG.md` — forward-looking work only |

---


<!-- archived from BACKLOG.md lines 15-103 -->
...
<!-- archived from BACKLOG.md lines 122-220 -->
...
<!-- archived from BACKLOG.md lines 303-411 -->
...
<!-- archived from BACKLOG.md lines 469-1085 -->
...
<!-- archived from BACKLOG.md lines 1432-1650 -->
...
<!-- archived from BACKLOG.md lines 1672-4333 -->
