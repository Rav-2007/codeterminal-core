...
#
# errcheck enforcement in CI is handled by scripts/errcheck-ceiling.sh, which
# runs as a separate step and enforces a ratchet: the existing count is
# grandfathered, but new unchecked errors fail the build.
